...
/*   Updated: 2024/11/17 17:34:28 by abekri           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
    ...
    {
        std::cout << "Creating DiamondTraps\n";
        DiamondTrap unnamed_diamond;
        DiamondTrap jessica("Jessica");
        DiamondTrap clone_jessica(jessica);

        std::cout << "\n--- Testing DiamondTrap Functions ---" << std::endl;
        std::cout << "Jessica has " << jessica.hitPoints << " hit points and " << jessica.energyPoints << " energy points.\n";
        jessica.attack("a dummy");
        jessica.takeDamage(20);
        std::cout << "Jessica now has " << jessica.hitPoints << " hit points and " << jessica.energyPoints << " energy points.\n";
        jessica.beRepaired(15);
        std::cout << "After repair: " << jessica.name << " has " << jessica.hitPoints << " hit points and " << jessica.energyPoints << " energy points.\n";
        ...
        std::cout << "Alex has " << alex.hitPoints << " hit points and " << alex.energyPoints << " energy points.\n";
        clone_jessica = alex;
        std::cout << "Clone Jessica after assignment has " << clone_jessica.hitPoints << " hit points and " << clone_jessica.energyPoints << " energy points.\n";
